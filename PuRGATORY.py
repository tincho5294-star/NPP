        ...
        if self.number==1:
            ...
            for i_shit,shit_current in enumerate(self.CVCS_entry):
                ...
                if shit_later is not None:
                    ...
                    shit_current["temp"],shit_later["temp"]=heat_exchange(shit_current["temp"],shit_later["temp"],0.3+max(60*(dt-abs((shit_later["progress"]-dt)-shit_current["progress"]))*abs(shit_current["velocity"]-shit_later["velocity"]),0),dt)
class Pump:
